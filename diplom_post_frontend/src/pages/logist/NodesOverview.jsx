...
export default function NodesOverview() {
  ...
  const { data, isLoading, isError, refetch } = useQuery({
    queryKey: ['logist', 'nodes-overview', queryParams],
  ...
  return (
    <>
      <PageHeader
        title="Вузли системи"
        subtitle="Огляд поштових, сортувальних і розподільчих вузлів"
      />
      ...
      <FilterPanel>
        <Stack direction={{ xs: 'column', md: 'row' }} spacing={2}>
          <SearchBar
            ...
            placeholder="Пошук за назвою або кодом вузла..."
          />
