...
import { useRoute, useStartRoute, useCompleteRoute } from '../../hooks/useRoutes'
...
function getNextStep(steps) {
  ...
  return steps.find((step) => !isStepCompleted(step)) || steps[steps.length - 1]
}
...
export default function RouteExecution() {
  ...
  const mutationError = startMutation.isError || completeMutation.isError
