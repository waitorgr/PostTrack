...
const LOCATION_TYPE_OPTIONS = [
  ...
  { value: 'DISTRIBUTION_CENTER', label: 'Розподільний центр' },
]
...
export default function AdminLocations() {
  ...
  const { data, isLoading, isError, refetch } = useQuery({
    queryKey: ['admin', 'locations', queryParams],
  ...
  return (
    <>
      <PageHeader
        title="Усі локації"
        subtitle="Глобальний довідник поштових, сортувальних і розподільчих вузлів"
      />
